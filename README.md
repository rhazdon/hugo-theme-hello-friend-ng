...
This theme was highly inspired by [hello-friend-ng](https://github.com/rhazdon/hugo-theme-hello-friend-ng). A lot of kudos for their great work.
...
You can download the theme manually by going to [https://github.com/321zer0/hugo-theme-hello-friend-ng-improved.git](https://github.com/321zer0/hugo-theme-hello-friend-ng-improved.git) and pasting it to `themes/hello-friend-ng-improved` in your root directory.

You can also clone it directly to your Hugo folder:

``` bash
$ git clone https://github.com/321zer0/hugo-theme-hello-friend-ng-improved.git themes/hello-friend-ng-improved
```

If you don't want to make any radical changes, it's the best option, because you can get new updates when they are available. To do so, include it as a git submodule:

``` bash
$ git submodule add https://github.com/321zer0/hugo-theme-hello-friend-ng-improved.git themes/hello-friend-ng-improved
```
...
<a href="https://www.buymeacoffee.com/mray" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/default-green.png" alt="Buy Me A Coffee" style="height: 51px !important;width: 217px !important;" ></a>

## Licence

Copyright © 2021 Muzaffar Auhammud

The theme is released under the MIT License. Check the [original theme license](https://github.com/321zer0/hugo-theme-hello-friend-ng-improved/blob/master/LICENSE.md) for additional licensing information.
