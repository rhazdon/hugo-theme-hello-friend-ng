...
(function (e) {
	...
	z(
		...
		function (e, d, h, c, a, t) {
			function m(b, p, a) {
				return (
					Math.sqrt(Math.pow(b - a[0], 2) + Math.pow(p - a[1], 2)) <= a[2] / 2
				);
			}
			var l = a.addEvent,
				r = a.extend,
						...
						for (
							...
							a[k] && this.axis
								? this.renderBackground(
										x(this.defaultBackgroundOptions, a[k]),
										k
								  )
								: this.background[k] &&
			...
			(function (c) {
					...
					if (this.isCircular) {
							...
							f.point &&
								...
								a.start &&
									(u = this.chart.inverted
										? this.translate(f.point.rectPlotY, !0)
										: f.point.x));
						else {
							var a = f.chartX || 0;
							var w = f.chartY || 0;
							u = this.translate(
								Math.atan2(w - b, a - g) - this.startAngleRad,
								!0
							);
						}
						...
						r(u) || ((a = f.chartX), (w = f.chartY)),
							r(a) &&
								...
								(u = this.translate(
									Math.min(
										Math.sqrt(Math.pow(a - g, 2) + Math.pow(w - b, 2)),
										n[2] / 2
									) -
										n[3] / 2,
									!0
				...
				function n(f, g, b) {
					...
					if ('polygon' === this.options.gridLineInterpolation)
						...
						F &&
							...
							(q.xBounds =
								F > -Math.PI / 2 && F < Math.PI / 2
									? [p, u.plotWidth]
									: [0, p]),
							(q.yBounds = [v + a[1] + (a[2] / 2) * Math.sin(F)]),
							(q.yBounds[0] +=
								(F > -Math.PI && 0 > F) || F > Math.PI ? -10 : 10));
					}
					return q;
				}
				function w(f) {
					...
					l = l.y;
					y &&
						((l = this.getCrosshairPosition(f, k, v)),
						(c = l[0]),
						(h = l[1]),
						(l = l[2]));
					if (this.isCircular)
						...
						for (
							...
							(w = d.getPosition(k[v], c)),
								b.push(v ? ['L', w.x, w.y] : ['M', w.x, w.y]);
					return b;
				}
				function A(f, g) {
					f = this.translate(f);
					return this.postTranslate(
						...
						k(this.isCircular ? g : 0 > f ? 0 : f, this.center[2] / 2) -
							this.offset
					);
				}
				function F() {
					...
					return {
						...
						y:
							g.plotTop +
							f[1] -
							{ high: 0.5, middle: 0.25, low: 0 }[b.align] * f[2] +
							(b.y || 0),
					};
				}
				function J(b) {
				...
				function B() {
					...
					(f.angular && this.isXAxis) ||
						...
						(this.endAngleRad =
							((k(n.endAngle, n.startAngle + 360) - 90) * Math.PI) / 180),
					...
					if ('colorAxis' === w) this.isRadial = !1;
						...
						n || u
							? ((this.isRadial = !0),
							  ...
							  this.labelCollector &&
									g.labelCollectors.push(this.labelCollector))
							: (this.isRadial = !1);
						f && p && (f.axis = this);
						this.isCircular = p;
					}
					...
					if (g) {
						...
						if (b.isRadial) {
							var m = b.getPosition(
								this.pos,
								b.center[2] / 2 +
									p(k(u.distance, -25), b.center[2] / 2, -b.center[2] / 2)
							);
							'auto' === u.rotation
								? g.attr({ rotation: a })
								: r(A) ||
								  (A =
										b.chart.renderer.fontMetrics(g.styles && g.styles.fontSize)
											.b -
										n.height / 2);
							r(F) ||
								(b.isCircular
									? (n.width > (b.len * b.tickInterval) / (b.max - b.min) &&
											(v = 0),
									  (F =
											a > v && a < 180 - v
												? 'left'
							...
							if (
								...
								15 > y || (180 <= y && 195 > y)
									...
									: 215 < y &&
									  270 >= y &&
									  (d = 'start' === c ? n.height : 0.25 * -n.height);
								15 > l
				...
				function N(f, g) {
					...
					return {
						x: b.plotLeft + n[0] + Math.cos(f) * g,
						y: b.plotTop + n[1] + Math.sin(f) * g,
					};
				}
				function Q() {
					this.isDirty = !1;
				...
				function U(f, g, b, n, u, w, a) {
					var k = this.axis;
					k.isRadial
						? ((f = k.getPosition(this.pos, k.center[2] / 2 + n)),
						  (g = ['M', g, b, 'L', f.x, f.y]))
				...
				c.prototype.translate = function () {
					...
					b.points.forEach(function (f) {
						...
						f.isNull
							? (f.plotY = null)
							: ((f.plotLow = n),
							  (f.plotHigh = a.translate(
									g ? b.modifyValue(u, f) : u,
									0,
									1,
									0,
									1
					...
					b.points.forEach(function (k) {
						...
						'undefined' !== typeof k.plotY &&
							...
							c.styledMode ||
								...
								(J.dashstyle =
									k.stemDashStyle || a.stemDashStyle || a.dashStyle),
								k.stem.attr(J),
								x &&
									...
									(L.dashstyle =
										k.whiskerDashStyle || a.whiskerDashStyle || a.dashStyle),
									k.whiskers.attr(L)),
								F &&
									...
									(B.dashstyle =
										k.boxDashStyle || a.boxDashStyle || a.dashStyle),
									k.box.attr(B)),
								...
								(H.dashstyle =
									k.medianDashStyle || a.medianDashStyle || a.dashStyle),
			...
			return (function () {
				...
				c.prototype.setOptions = function () {
					var c = this.ranges,
						...
						e = {
							align:
								this.legend.options.rtl || 'left' === k.labels.align
									? 'right'
									: 'left',
							zIndex: k.zIndex,
						},
		...
		function (e, d, h, c) {
			...
			(function (c) {
				...
				function k(b) {
					...
					for (g = 0; g < c; g++)
						if (
							(b[g].legendItemHeight &&
								(b[g].itemHeight = b[g].legendItemHeight),
							b[g] === b[c - 1] ||
								(b[g + 1] &&
									b[g]._legendItemPos[1] !== b[g + 1]._legendItemPos[1]))
						) {
							a.push({ height: 0 });
							var u = a[a.length - 1];
							for (f; f <= g; f++)
								b[f].itemHeight > u.height && (u.height = b[f].itemHeight);
							u.step = g;
						}
					return a;
				}
				...
				c.compose = function (c, k, d) {
					-1 === x.indexOf(c) &&
						(x.push(c),
						a({ legend: { bubbleLegend: e } }),
						l(c.prototype, 'drawChartBox', b));
					...
					!b &&
						...
						this.points.forEach(function (b) {
							...
							f &&
								f.width &&
								(this.hasRendered ||
									f.attr({ x: b.plotX, y: b.plotY, width: 1, height: 1 }),
			...
			e.prototype.beforePadding = function () {
				...
				B.length &&
					...
					[
						...
						'undefined' === typeof y(b.options[f[0]], b[f[1]]) &&
							(b[f[0]] += f[2] / t);
					}));
			};
						...
						u
							...
							: ((h.height = p),
							  ...
							  (l.tooltipPos = f.inverted
									...
									: [
											d.left - f.plotLeft + A + h / 2,
											c.pos - f.plotTop + e + p / 2,
											p,
									  ]));
					});
				};
			...
			h = (function (d) {
				...
				h.prototype.translate = function () {
					...
					b.points.forEach(function (a) {
						...
						u = h.toPixels(u, !0);
						var r = (v = c.plotHeight - u - (c.plotHeight - m))
							? (q * (p - u)) / v
							: 0;
						var y = v ? (q * (p + n - u)) / v : 0;
						v = d - r + q;
			...
			e.networkgraphIntegrations = {
				verlet: {
					...
					barycenter: function () {
						...
						this.nodes.forEach(function (a) {
							a.fixedPosition ||
								((a.plotX -= h / a.mass / a.degree),
								(a.plotY -= c / a.mass / a.degree));
						});
					},
				...
				euler: {
					...
					integrate: function (d, e) {
						...
						0 !== c &&
							((e.plotX +=
								(e.dispX / c) * Math.min(Math.abs(e.dispX), d.temperature)),
							(e.plotY +=
								(e.dispY / c) * Math.min(Math.abs(e.dispY), d.temperature)));
					},
					getK: function (d) {
		...
		function (e, d) {
			...
			d(h.prototype, {
				...
				getBoxPosition: function (c) {
					...
					return c.plotX < this.box.left + this.box.width / 2
						? a
							? 0
							: 3
						: a
		...
		function (e, d, h, c) {
			...
			l(h.layouts['reingold-fruchterman'].prototype, {
				init: function (b) {
					...
					this.attractiveForce = x(
						b.attractiveForce,
						this.integration.attractiveForceFunction
					);
					this.repulsiveForce = x(
						b.repulsiveForce,
				...
				setCircularPositions: function () {
					function b(a) {
						a.linksFrom.forEach(function (a) {
							h[a.toNode.id] ||
								((h[a.toNode.id] = !0), l.push(a.toNode), b(a.toNode));
						});
					}
					var a = this.box,
						c = this.nodes,
				...
				barnesHutApproximation: function (b, a) {
					...
					if (b !== a && 0 !== d)
						if (a.isInternal)
							...
							(e = this.repulsiveForce(d, this.k)),
								this.force('repulsive', b, e * a.mass, c, d);
					return l;
				},
				...
				attractiveForces: function () {
					...
					b.links.forEach(function (e) {
						e.fromNode &&
							...
							(c = b.vectorLength(a)),
							0 !== c &&
								((d = b.attractiveForce(c, b.k)),
								b.force('attractive', e, d, a, c)));
					});
				},
				...
				barycenter: function () {
					...
					b.forEach(function (l) {
						a.options.splitSeries && !l.isParentNode
							? ((e = l.series.parentNode.plotX),
							  (k = l.series.parentNode.plotY))
							: ((e = d.width / 2), (k = d.height / 2));
						l.fixedPosition ||
							((l.plotX -=
								((l.plotX - e) * c) / (l.mass * Math.sqrt(b.length))),
							(l.plotY -=
								((l.plotY - k) * c) / (l.mass * Math.sqrt(b.length))));
					});
				},
				...
				setCircularPositions: function () {
					...
					d.forEach(function (d, l) {
						a.options.splitSeries && !d.isParentNode
							? ((e = d.series.parentNode.plotX),
							  (k = d.series.parentNode.plotY))
					...
					a.nodes.forEach(function (k) {
						...
						a.nodes.forEach(function (h) {
							...
							k === h ||
								...
								((b = a.getDistXY(k, h)),
								(d =
									a.vectorLength(b) - (k.marker.radius + h.marker.radius + e)),
								0 > d &&
									((k.degree += 0.01),
									k.neighbours++,
									(c = a.repulsiveForce(
										-d / Math.sqrt(k.neighbours),
										a.k,
										k,
										h
									))),
		...
		function (e, d, h, c, a) {
			...
			e = (function (a) {
				...
				c.prototype.addLayout = function () {
					...
					var e = b[a.type];
					e ||
						((a.enableSimulation = q(g.forExport)
							? !g.forExport
							: a.enableSimulation),
				...
				c.prototype.createParentNodes = function () {
					...
					d ||
						...
						a.parentNode &&
							((g.plotX = a.parentNode.plotX), (g.plotY = a.parentNode.plotY)),
						(a.parentNode = g),
						...
						d &&
							...
							d.nodes.forEach(function (d) {
								a &&
									...
									0 > c &&
										(d.series.addPoint(
											z(a.options, { plotX: a.plotX, plotY: a.plotY }),
											!1
										),
				...
				c.prototype.placeBubbles = function (a) {
					...
					if (a.length) {
						...
						if (1 < a.length)
							for (
								f.push([[0, 0 - a[1][2] - a[0][2], a[1][2], a[1][3], a[1][4]]]),
									h = 2;
								h < a.length;
								h++
							)
				...
				c.prototype.resizeRadius = function () {
					...
					if (1e-10 < Math.abs(c - 1)) {
						...
						(a.diffY = k / 2 + e - l - (q - l) / 2),
							(a.diffX = h / 2 + g - m - (r - m) / 2);
				};
		...
		function (e, d, h, c) {
			...
			c = (function (c) {
				...
				d.prototype.getGraphPath = function () {
					for (
						var a = r.prototype.getGraphPath.call(this), b = a.length + 1;
						b--;
								...
								(y = Math.max(h, h + G) + t[0]),
									...
									m.isSum
										...
										? (0 <= G
										  ...
										  (C.height = Math.abs(
												C.y -
													Math.min(b.translate(G, !1, !0, !1, !0) || 0, b.len)
										  )),
										  (k += t[1]),
										  (m.below = r <= e))
										: ((C.height =
						...
						v &&
							...
							l
								? ((v = v.connectorThreshold),
								  (x =
										Math.round(b.translate(v, 0, 1, 0, 1) + (k ? x : 0)) - d))
		...
		function (e, d, h, c, a, t, m, l, r) {
			...
			D.toXY = function (a) {
				...
				k &&
					h &&
					!h.isRadialBar &&
					(a.plotY = g = 'number' === typeof l ? d.translate(l) || 0 : 0);
				a.rectPlotX = e;
				a.rectPlotY = g;
			...
			m.spline &&
				...
				m.areasplinerange &&
					(m.areasplinerange.prototype.getPointSpline =
						m.spline.prototype.getPointSpline));
			b(
				t,
				'afterTranslate',
				function () {
						...
						for (; e--; ) {
							...
							if (d.inverted) {
								...
								if (c && g.stacking) {
									if (
										((B =
											g.stacking.stacks[(0 > B ? '-' : '') + this.stackKey]),
								...
								b.plotY =
									(q(this.translatedThreshold) &&
										(E < this.translatedThreshold ? E : D)) - l;
							} else
								(E = y + l),
